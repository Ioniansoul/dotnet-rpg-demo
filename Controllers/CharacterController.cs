namespace dotnet_rpg.Controllers
{
    ...
    public class CharacterController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ServiceResponse<List<GetCharacterResponseDto>>>> AddCharacter(AddCharacterDto newCharacter)
        {
            return Ok(await _characterService.AddCharacter(newCharacter));
        } 

        [HttpPut]
        public async Task<ActionResult<ServiceResponse<UpdateCharacterResponseDto>>> UpdateCharacter(UpdateCharacterResponseDto updatedCharacter)
        {
